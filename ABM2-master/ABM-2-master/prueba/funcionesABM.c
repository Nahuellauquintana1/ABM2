...
void listarAlumnos (eAlumno listaDeAlumnos[], int tam, eLocalidad listaDeLocalidades[], int tamLocalidaes)
{
    int i;
    int flagEstado = 1;
    printf("Legajo\t\tNombre\t\tNota\tLocalidad\n");
    for(i = 0; i < tam; i++)
    {
        if(listaDeAlumnos[i].estado == 0)
        {
            ...
            buscarAlumnoPorLocalidad(listaDeAlumnos[i],listaDeLocalidades,tamLocalidaes);
        }
...
int cargarNuevoCosa(eAlumno lista[], int tam,eLocalidad listaLocalidades[],int tamLocalidades)
{
    int i;
    ...
    if(i!=-1)
    {
        ...
        printf("Elija Localidad");
        mostrarLocalidadesSubMenu(lista[i], tam);
        lista[i].estado = 0;
...
int buscarAlumnoPorLocalidad(eAlumno unAlumno, eLocalidad localidades[], int tamLocalidades)
{
    int i;

    for(i = 0; i < tamLocalidades; i++)
    {
        if(unAlumno.idLocalidad ==localidades[i].id)
        {
...
void mostrarLocalidadesSubMenu(eAlumno unAlumno, int tam)
{
    int opcion;
    do
    {
