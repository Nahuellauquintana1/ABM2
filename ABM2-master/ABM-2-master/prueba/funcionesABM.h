 ...
 *
 */
void listarAlumnos (eAlumno listaDeAlumnos[], int tam, eLocalidad listaDeLocalidades[],int tamLocalidades);
 ...
 *
 */
int cargarNuevoCosa(eAlumno listaDeAlumnos[], int tam,eLocalidad listaDeLocalidades[], int tamLocalidades);
...
void mostrarLocalidadesSubMenu(eAlumno Alumno, int tam);
